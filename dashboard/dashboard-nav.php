...
<body>
  ...
  <?php if ($page == 'vbooks') { ?><li class="nav-item"><a href="vbooks.php" class="nav-link active">View Books</a></li>
  <?php } else { ?><li><a href="vbooks.php" class="nav-link ">View Books</a></li><?php } ?>
